  ...
  <div class="container flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
    ...
    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" action="<?php echo url('/login/auth'); ?>" method="POST">
          ...
          <button type="submit" class="button-auth">Masuk</button>
          <p class="text-sm font-light text-gray-500 dark:text-gray-400">
            Belum punya akun? <a href="<?php echo url('/register'); ?>" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Mendaftar</a>
          </p>
        </form>
      </div>
    </div>
