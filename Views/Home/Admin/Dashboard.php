...
<div class="section-container mt-5">
  ...
  <p class="mb-4">Anda login sebagai <?php echo $user['role']; ?></p>
  <a href="<?php echo url('/menu/create') ?>" class="button-logout">Buat Menu Baru</a>
      ...
      <tbody>
        ...
        <?php foreach ($foods as $food) : ?>
          <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
            ...
            <td class="px-6 py-4">
              <a href="<?php echo url('/menu/' . $food['id'] . '/edit'); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
              |
              <button data-modal-target="popup-modal-<?= $food['id'] ?>" data-modal-toggle="popup-modal-<?= $food['id'] ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">
                Hapus
              </button>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                      ...
                      <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda ingin menghapus menu <?php echo $food['nama']; ?>?</h3>

                      <div class="flex justify-center">
                        <form action="<?php echo url('/menu/' . $food['id'] . '/delete'); ?>" method="post">
      ...
      <tbody>
        ...
        <?php foreach ($drinks as $drink) : ?>
          <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
            ...
            <td class="px-6 py-4">
              <a href="<?php echo url('/menu/' . $drink['id'] . '/edit'); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
              |
              <button data-modal-target="popup-modal-<?= $drink['id'] ?>" data-modal-toggle="popup-modal-<?= $drink['id'] ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline" type="button">
                Hapus
              </button>
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                      ...
                      <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda ingin menghapus menu <?php echo $drink['nama']; ?>?</h3>

                      <div class="flex justify-center">
                        <form action="<?php echo url('/menu/' . $drink['id'] . '/delete'); ?>" method="post">
                          <button type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Ya, Hapus
                          </button>
                        </form>
