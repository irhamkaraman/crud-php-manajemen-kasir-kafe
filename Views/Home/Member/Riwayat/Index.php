        ...
        <?php foreach ($listKeranjang as $irham) : ?>
          <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
            ...
            <td class="px-6 py-4">
              ...
              <?php if ($irham['tandai'] == 1) { ?>
                <a class="font-medium text-blue-200 cursor-not-allowed" disabled>Tandai</a>
              <?php } else { ?>
                <a href="<?php echo url('/riwayat/' . $irham['id'] . '/tandai'); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Tandai</a>
              <?php } ?>
              |
